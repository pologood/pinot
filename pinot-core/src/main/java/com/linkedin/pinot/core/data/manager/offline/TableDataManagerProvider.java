...
public class TableDataManagerProvider {
  ...
  public static TableDataManager getTableDataManager(@Nonnull TableDataManagerConfig tableDataManagerConfig,
    ...
    String tableDataManagerType = tableDataManagerConfig.getTableDataManagerType().toLowerCase();
    ...
    switch (tableDataManagerType) {
      ...
      case "realtime":
        ...
        break;
      default:
        throw new UnsupportedOperationException("Unsupported table data manager type: " + tableDataManagerType);
    }
