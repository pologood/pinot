...
public class ScheduledRequestHandlerTest {
  ...
  public void testQueryProcessingException()
      throws Exception {
    ScheduledRequestHandler handler = new ScheduledRequestHandler(new QueryScheduler(null, serverMetrics) {
      @Override
      public ListenableFuture<byte[]> submit(QueryRequest queryRequest) {
